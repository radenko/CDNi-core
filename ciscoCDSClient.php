    ...
    class ciscoCDSClient {
        ...
        */ 
         ...
         */
            ...
            echo "Response after deletion:"; var_dump($resXML);
        }
		...
		*/          
        ...
        public function listContentOrigins() {
        /*        
        https://<cdsmIpAddress>:8443/servlet/com.cisco.unicorn.ui.ListApiServlet?action=getContentOrigins&param=all
		*/  
            $params = array ();
            $params ['param'] = 'all';           
			...
			while ($amountCOs > 0) {
				...
				$cnt=$cnt+1;
				$amountCOs=$amountCOs-1;
			}			
			return $res;
			}
			elseif (empty($amountCOs)){
					return $amountCOs;
			}
        }
